...
public class TestSPT {
    public static void main(String[] args) {
        ...
        WeightedGraph<String>.SPT tree1 = graph1.getSPT(graph1.getIndex("Chicago"));
        System.out.println(tree1.getAllPathsToRoot());
        ...
        WeightedGraph<String> graph2 = new WeightedGraph<>(v, edges);
        WeightedGraph<String>.SPT tree2 = graph2.getSPT(3);
        System.out.println("\n");
        System.out.println(tree2.getAllPathsToRoot());
