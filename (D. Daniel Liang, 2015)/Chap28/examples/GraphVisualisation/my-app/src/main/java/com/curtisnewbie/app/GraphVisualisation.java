...
/**
 * It is a map (essentially a graph where the vertices are the location on the
 * map)
 */
public class GraphVisualisation extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // construct a graph using these data
        Graph<City> graphOfCities = new UnweightedGraph<>(vertices, edges);

        Scene scene = new Scene(new GraphView(graphOfCities), 750, 450);
        primaryStage.setTitle("Map (Demo of Graph Visualisation)");
